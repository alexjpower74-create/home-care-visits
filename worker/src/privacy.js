...
export const MEDICATION_RE = /\b(administer(ed|s|ing)?|administration|doses?|dosage|inject(ed|ing|ions?)?|insulin|\d+ ?(mg|mcg|ml)|(give|gave|given|giving)\s+((him|her|them|the|his|their)\s+)?(meds?|medications?|pills?|tablets?))\b/i
