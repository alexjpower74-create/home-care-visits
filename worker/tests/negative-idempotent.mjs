...
await runControl({
  ...
  api: true,
  breaks: [
    { file: 'migrations/0001_init.sql', find: '  id TEXT PRIMARY KEY,\n  visit_id INTEGER NOT NULL', replace: '  id TEXT NOT NULL,\n  visit_id INTEGER NOT NULL' },
    { file: 'src/index.js', find: "'SELECT * FROM events WHERE id = ?1 LIMIT 1'", replace: "'SELECT * FROM events WHERE id = ?1 AND 0 LIMIT 1'" }
  ],
